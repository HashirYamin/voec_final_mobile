import '../brandaorrproductspage_screen/widgets/list353416575277258397_item_widget.dart';
...
class BrandaorrproductspageScreen
    extends GetWidget<BrandaorrproductspageController> {
  const BrandaorrproductspageScreen({Key? key})
      : super(
          key: key,
        );
  ...
  /// Section Widget
  Widget _buildRow35341651919370130() {
    return Align(
      alignment: Alignment.topCenter,
      child: Container(
  ...
  /// Section Widget
  Widget _buildList353416575277258397() {
    return Align(
      alignment: Alignment.bottomCenter,
      child: Padding(
        ...
        child: Obx(
          () => ListView.separated(
            ...
            itemCount: controller.brandaorrproductspageModelObj.value
                .list353416575277258397ItemList.value.length,
            itemBuilder: (context, index) {
              List353416575277258397ItemModel model = controller
                  .brandaorrproductspageModelObj
                  .value
                  .list353416575277258397ItemList
                  .value[index];
              return List353416575277258397ItemWidget(
                model,
              );
            },
          ),
