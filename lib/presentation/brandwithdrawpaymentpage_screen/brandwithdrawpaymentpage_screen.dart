...
class BrandwithdrawpaymentpageScreen
    extends GetWidget<BrandwithdrawpaymentpageController> {
  const BrandwithdrawpaymentpageScreen({Key? key})
      : super(
          key: key,
        );
