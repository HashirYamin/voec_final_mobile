...
class BrandeditproductpageScreen
    extends GetWidget<BrandeditproductpageController> {
  const BrandeditproductpageScreen({Key? key})
      : super(
          key: key,
        );
