...
class CustomerprofilesettingspageScreen
    extends GetWidget<CustomerprofilesettingspageController> {
  const CustomerprofilesettingspageScreen({Key? key})
      : super(
          key: key,
        );
                                              ...
                                              child: Container(
                                                ...
                                                child: Column(
                                                  ...
                                                  children: [
                                                    ...
                                                    _buildPromotionsButton(),
                                                    SizedBox(height: 22.v),
                                                    _buildFinanceButton(),
                                                    SizedBox(height: 22.v),
                                                    _buildSupportButton(),
                                                    SizedBox(height: 22.v),
                                                    _buildCommunityLegalButton(),
  ...
  Widget _buildAccountButton() {
    return CustomElevatedButton(
      ...
      decoration: CustomButtonStyles.gradientPrimaryToPrimaryTL163Decoration,
    );
  }
  ...
  /// Section Widget
  Widget _buildCommunityLegalButton() {
    return CustomElevatedButton(
      text: "msg_community_legal".tr,
      buttonStyle: CustomButtonStyles.none,
      decoration: CustomButtonStyles.gradientPrimaryToPrimaryTL163Decoration,
    );
  }
